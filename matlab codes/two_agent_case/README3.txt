...
You can manually end the running code by stopping the simulation at any time. Since there are two vehicles in this case, more functions were created to ensure simplicity.
